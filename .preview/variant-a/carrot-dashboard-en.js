...
`;
    themeStyle.textContent+=`.hour.driving i{background:#bbc7d8;opacity:1}.hour.parked i{background:repeating-linear-gradient(135deg,#526077 0px,#526077 3px,#263143 3px,#263143 6px);opacity:1}.hour.charging i{background:#5ad46d;opacity:1}`;
    ...
    themeStyle.textContent+=`.hour.last-known i{background:repeating-linear-gradient(135deg,#526077 0px,#526077 3px,#263143 3px,#263143 6px);opacity:1}.hour.charging{background:rgba(90,212,109,.18)}.hour.charging i{background:#5ad46d;opacity:1}`;
    themeStyle.textContent+=`
...
.hour.parked i,.hour.last-known i{background:repeating-linear-gradient(135deg,var(--park-stripe) 0 2px,var(--park-base) 2px 7px);opacity:1}
...
.hour.parked.soc-low i,.hour.last-known.soc-low i{background:repeating-linear-gradient(135deg,#ffffff00 0 5px,#ffffff35 5px 7px),linear-gradient(180deg,#f28b32,#ffc46b)}
.hour.parked.soc-critical i,.hour.last-known.soc-critical i{background:repeating-linear-gradient(135deg,#ffffff00 0 5px,#ffffff35 5px 7px),linear-gradient(180deg,#ed4c53,#ff9092)}
...
/* Variant A: charging hour = one bolt outline with SOC fill bar inside */
.hour.charging .bolt{position:absolute;left:50%;bottom:0;transform:translateX(-50%);width:34px;height:calc(100% + 24px);z-index:2;pointer-events:none;line-height:0}
.hour.charging .bolt svg{display:block;width:100%;height:100%;overflow:visible;color:#5ad46d;stroke:var(--bolt-outline)}
.hour.charging .bolt i{position:absolute;left:37%;right:37%;bottom:0;border-radius:3px 3px 0 0;background:linear-gradient(180deg,#2acb58,#7ce88d)}
@container(max-width:700px){.hour.charging .bolt{width:26px}}
